...
HIDDEN_TARGETS = {
    ...
    BTN_HIDDEN_DELETE_TEMPLATE: PAGE_DELETE_TEMPLATE,
    BTN_HIDDEN_DISPLAY_TEMPLATES: PAGE_DISPLAY_TEMPLATES,
    BTN_HIDDEN_DOWNLOAD: PAGE_DOWNLOAD,
    BTN_HIDDEN_EXPORT_EZEML_DATA_PACKAGE: PAGE_EXPORT_EZEML_DATA_PACKAGE,
    BTN_HIDDEN_FAQ : PAGE_FAQ,
    ...
    BTN_HIDDEN_MANAGE_TEMPLATES: PAGE_MANAGE_TEMPLATES,
    ...
    BTN_HIDDEN_OPEN_TEMPLATE: PAGE_OPEN_TEMPLATE,
    BTN_HIDDEN_PREVIEW_DATA_PORTAL: PAGE_PREVIEW_DATA_PORTAL,
    BTN_HIDDEN_RELEASE_TO_OWNER: PAGE_RELEASE_TO_OWNER,
    BTN_HIDDEN_RENAME_PACKAGE: PAGE_RENAME_PACKAGE,
    BTN_HIDDEN_SAVE: PAGE_SAVE,
    BTN_HIDDEN_SAVE_AS: PAGE_SAVE_AS,
    BTN_HIDDEN_SAVE_AS_TEMPLATE: PAGE_SAVE_AS_TEMPLATE,
    BTN_HIDDEN_SETTINGS: PAGE_SETTINGS,
    BTN_HIDDEN_USER_GUIDE: PAGE_USER_GUIDE,
    BTN_HIDDEN_VALIDATE_EML: PAGE_VALIDATE_EML,
