...
def enable_edi_curation_mail_body(server=None, package_id=None, filename=None, name=None, email_address=None, notes=None,
    ...
    msg = 'Your data package is under review by EDI\'s Data Curation Team.' + '\n\n' + \
        'What happens next:\n\n' + \
        'Review\n' + \
        '   A member of EDI\'s Data Curation Team will review your submission and help with\n' + \
        '   any corrections or fine-tuning that may be needed. When the package is ready, EDI\n' + \
        '   will send you a link to a proof for your review. This proof will show how the\n' + \
        '   package will appear in the EDI Data Portal when it is published.\n\n' + \
        'Publication\n' + \
        '   When you are satisfied with the data package, EDI will assign a DOI and upload the\n' + \
        '   package to the EDI Data Repository, publishing it. The published data package will then\n' + \
        '   be discoverable through the EDI Data Portal Search Interface, the DataONE Repository\n' + \
        '   Network, and the Google Dataset Search Engine.\n\n' + \
        'If you have any questions or concerns, please contact EDI at support@edirepository.org,\n' + \
        'referencing your package name.\n\n\n'
    msg += f'The following information is provided for EDI\'s use:\n\n' + \
        '   User\'s name: ' + name + '\n' + \
    ...
    if package_id and another_package_with_same_name_is_under_edi_curation(package_id):
        msg += '\n' + \
            ...
            '      This may indicate that the package has been duplicated in multiple accounts, which may\n' + \
            '      be unintentional and cause some confusion. Please contact the user to clarify the situation.'
    return msg
...
def enable_edi_curation_2(filename=None, name=None, email_address=None, notes=None, is_update:bool=False, update_package=None):
    try:
        ...
        if not Config.DISABLE_ENABLE_EDI_CURATION_EMAILS:
            mimemail.send_mail(subject=f'Data package submitted to EDI: "{filename}"',
                               msg=msg,
                               to=email_address,
                               to_name=name,
                               cc=Config.TO)
